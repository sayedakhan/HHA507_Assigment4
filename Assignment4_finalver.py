...
tukey1way_EDUCATION_RACE = pd.DataFrame(post_hoc_res.summary())
...
post_hoc_res = comp.tukeyhsd()
tukey1way_HOURSPERWEEK_GENDER = pd.DataFrame(post_hoc_res.summary())
...
post_hoc_res = comp.tukeyhsd()
tukey1way_HOURSPERWEEK_OCCUPATION = pd.DataFrame(post_hoc_res.summary())
...
post_hoc_res = comp.tukeyhsd()
tukey1way_AGE_GENDER = pd.DataFrame(post_hoc_res.summary())
